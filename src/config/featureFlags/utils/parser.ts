...
/**
 * Parse the feature flag string from an environment variable.
 * @param flagString The feature flag string read from an environment variable.
...
export function parseFeatureFlag(flagString?: string): Partial<IFeatureFlags> {
  ...
  // Replace Chinese commas with standard commas and split the string by comma
