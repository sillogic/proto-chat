...
export const FeatureFlagsSchema = z.object({
  ...
  // ProtoChat custom flags
  hide_skill_store: FeatureFlagValue.optional(),
});
...
export const mapFeatureFlagsEnvToState = (config: IFeatureFlags, userId?: string) => {
  return {
    ...
    hideSkillStore: evaluateFeatureFlag(config.hide_skill_store, userId),
  };
};
