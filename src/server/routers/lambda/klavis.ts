...
export const klavisRouter = router({
  ...
  createServerInstance: klavisProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      // Save to database using the provided identifier (format: lowercase, spaces replaced by hyphens)
      ...
      const isAuthenticated = !oauthUrl; // If there is no oauthUrl, authentication is not required or has already been completed
