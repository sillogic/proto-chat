export default {
  ...
  'config.resolution.options.0.5K': '0.5K',
  ...
  'generation.actions.referenceApplied': 'Reference image updated',
  ...
  'notSupportGuide.desc':
    'The current deployment mode does not support AI image generation. Switch to the <1>server database deployment mode</1>, or use <3>ProtoChat Cloud</3>.',
