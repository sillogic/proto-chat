export default {
  ...
  'memory.enabled.desc':
    'Allow ProtoChat to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'skillStore.tabs.lobehub': 'ProtoChat',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  // ProtoChat Skill Providers i18n
