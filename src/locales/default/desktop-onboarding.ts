export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using ProtoChat Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve ProtoChat. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve ProtoChat',
  ...
  'screen5.actions.signInCloud': 'Sign in to ProtoChat Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your ProtoChat Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'ProtoChat Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own ProtoChat server instance',
