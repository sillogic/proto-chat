export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote ProtoChat server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'ProtoChat Cloud',
