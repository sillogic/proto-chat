export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>support@protochat.ai</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>support@protochat.ai</email>.',
  ...
  'createGuide.func1.title': 'Submit in ProtoChat',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the ProtoChat Community.',
  'footer.title': 'Share your creation on ProtoChat Community today',
  ...
  'models.providerInfo.apiTooltip': 'ProtoChat supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'ProtoChat Official Service',
