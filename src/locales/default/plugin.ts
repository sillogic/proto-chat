export default {
  ...
  'protocolInstall.official.badge': 'ProtoChat Official Skill',
  'protocolInstall.official.description': 'Official ProtoChat Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. ProtoChat does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.title': 'Add skills to ProtoChat',
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'ProtoChat Skills',
