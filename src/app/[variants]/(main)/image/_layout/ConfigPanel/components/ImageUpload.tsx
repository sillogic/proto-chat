...
import { type ImageConstraints } from '@/app/[variants]/(main)/image/_layout/ConfigPanel/utils/imageValidation';
...
/**
 * Circular progress component (reused from MultiImagesUpload)
 */
