...
const flexSupportedModels = ['gpt-5', 'o3', 'o4-mini']; // Flex processing applies only to these models
...
export const params = {
  ...
  models: async ({ client }) => {
    ...
    // Automatically detect model provider and select the corresponding configuration
