...
exports.LobeComfyUI = void 0;
const utils_1 = require("@lobechat/utils");
const debug_1 = __importDefault(require("debug"));
const comfyuiErrorParser_1 = require("../../utils/comfyuiErrorParser");
const createError_1 = require("../../utils/createError");
const log = (0, debug_1.default)('lobe-image:comfyui');
/**
        ...
        switch (authType) {
            case 'basic': {
                if (username && password) {
                    return { Authorization: `Basic ${(0, utils_1.createBasicAuthCredentials)(username, password)}` };
                }
                return undefined;
            }
            case 'bearer': {
    ...
    async createImage(payload) {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                const { error: parsedError, errorType } = (0, comfyuiErrorParser_1.parseComfyUIErrorMessage)(errorData);
                throw createError_1.AgentRuntimeError.createImage({
                    error: parsedError,
                    errorType,
                    provider: 'comfyui',
            ...
            const { error: parsedError, errorType } = (0, comfyuiErrorParser_1.parseComfyUIErrorMessage)(error);
            throw createError_1.AgentRuntimeError.createImage({
                error: parsedError,
                errorType,
                provider: 'comfyui',
...
exports.LobeComfyUI = LobeComfyUI;
