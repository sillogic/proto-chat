...
exports.LobeOpenRouterAI = exports.params = void 0;
    ...
    chatCompletion: {
        handlePayload: (payload) => {
            ...
            if (thinking?.type === 'enabled') {
                const modelConfig = model_bank_1.openrouter.find((m) => m.id === model);
                ...
                const maxTokens = getMaxTokens() || 32000; // Claude Opus 4 has minimum maxOutput
                reasoning = {
    ...
    models: async () => {
        ...
        const formattedModels = modelList.map((model) => {
            ...
            return {
                ...
                id: model.id,
                maxOutput: typeof top_provider.max_completion_tokens === 'number'
        ...
        return await (0, modelParse_1.processMultiProviderModelList)(formattedModels, 'openrouter');
    },
    provider: model_bank_1.ModelProvider.OpenRouter,
};
exports.LobeOpenRouterAI = (0, openaiCompatibleFactory_1.createOpenAICompatibleRuntime)(exports.params);
