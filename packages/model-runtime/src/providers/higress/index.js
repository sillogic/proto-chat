...
exports.LobeHigressAI = exports.params = void 0;
const uniqueId_1 = __importDefault(require("lodash-es/uniqueId"));
...
exports.params = {
    constructorOptions: {
        defaultHeaders: {
            ...
            'X-Title': 'LobeHub',
            'x-Request-Id': (0, uniqueId_1.default)('lobe-chat-'),
        },
    },
    debug: {
    ...
    models: async ({ client }) => {
        ...
        return modelList
            ...
            return {
                ...
                reasoning: model.description.includes('reasoning') || knownModel?.abilities?.reasoning || false,
    ...
    provider: model_bank_1.ModelProvider.Higress,
};
exports.LobeHigressAI = (0, openaiCompatibleFactory_1.createOpenAICompatibleRuntime)(exports.params);
