    ...
    try {
        ...
        if (hostnameParts.length > 1) {
            ...
            if (hostnameParts[secondLevelDomainIndex].length < 5) {
                ...
                hostnameParts[secondLevelDomainIndex] = hostnameParts[secondLevelDomainIndex].replace(/^(.*?)(\w{2})(\w+)(\w{2})$/, (_, prefix, start, middle, end) => `${prefix}${start}****${end}`);
            }
        }
...
//# sourceMappingURL=desensitizeUrl.js.map