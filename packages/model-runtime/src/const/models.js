...
exports.hasTemperatureTopPConflict = exports.temperatureTopPConflictModelPatterns = exports.isThinkingWithToolClaudeModel = exports.thinkingWithToolClaudeModelPatterns = exports.isContextCachingModel = exports.contextCachingModelPatterns = exports.responsesAPIModels = exports.disableStreamModels = exports.systemToUserModels = void 0;
exports.systemToUserModels = new Set([
    'o1-preview',
...
exports.disableStreamModels = new Set([
    'o1',
    'o1-2024-12-17',
    'o1-pro',
    'o1-pro-2025-03-19',
 ...
 */
exports.responsesAPIModels = new Set([
    'o1-pro',
    'o1-pro-2025-03-19',
    'o3-deep-research',
 ...
 */
exports.contextCachingModelPatterns = [
...
const isContextCachingModel = (model) => {
    return exports.contextCachingModelPatterns.some((pattern) => pattern.test(model));
};
exports.isContextCachingModel = isContextCachingModel;
/**
 * Regex patterns for Claude models that support thinking with tools (3.7+)
 */
exports.thinkingWithToolClaudeModelPatterns = [
    // Claude 4.5 series - Anthropic API
    /^claude-(opus|sonnet|haiku)-4-5-/,
    // Claude 4 series - Anthropic API
    /^claude-(opus|sonnet)-4-/,
...
const isThinkingWithToolClaudeModel = (model) => {
    return exports.thinkingWithToolClaudeModelPatterns.some((pattern) => pattern.test(model));
};
exports.isThinkingWithToolClaudeModel = isThinkingWithToolClaudeModel;
/**
 ...
 */
exports.temperatureTopPConflictModelPatterns = [
...
const hasTemperatureTopPConflict = (model) => {
    return exports.temperatureTopPConflictModelPatterns.some((pattern) => pattern.test(model));
};
exports.hasTemperatureTopPConflict = hasTemperatureTopPConflict;
