    ...
    describe('chat', () => {
      ...
      describe('DEBUG', () => {
        it(`should call debugStream and return StreamingTextResponse when ${chatDebugEnv} is 1`, async () => {
          // Arrange
          const mockProdStream = new ReadableStream() as any; // Mock prod stream
          ...
          mockDebugStream.toReadableStream = () => mockDebugStream; // Add the toReadableStream method

          // Mock the return value of chat.completions.create, including the mocked tee method
          ...
          // Assumed test function call; you may need to adjust based on actual conditions
          await instance.chat({
            messages: [{ content: 'Hello', role: 'user' }],
            model: chatModel,
            stream: true,
