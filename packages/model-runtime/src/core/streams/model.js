...
exports.createModelPullStream = void 0;
/**
 * 将异步迭代器转换为 JSON 格式的 ReadableStream
 */
const createModelPullStream = (iterable, model, { onCancel, // 新增：取消时调用的回调函数
 } = {}) => {
    let iterator; // 在外部跟踪迭代器以便取消时可以调用 return
...
exports.createModelPullStream = createModelPullStream;
