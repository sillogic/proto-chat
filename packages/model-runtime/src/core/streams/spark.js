...
exports.SparkAIStream = exports.transformSparkStream = void 0;
exports.transformSparkResponseToStream = transformSparkResponseToStream;
const usageConverters_1 = require("../usageConverters");
const protocol_1 = require("./protocol");
function transformSparkResponseToStream(data) {
                ...
                choices: choices.map((choice) => {
                    ...
                    return {
                        delta: {
                            ...
                            tool_calls: toolCallsArray.map((tool, index) => ({
...
const transformSparkStream = (chunk) => {
        ...
        if (toolCallsArray.length > 0) {
            return {
                data: toolCallsArray.map((toolCall, index) => ({
                    ...
                    id: toolCall.id || (0, protocol_1.generateToolCallId)(index, toolCall.function?.name),
        ...
        */
        if (chunk.usage) {
            return [
                ...
                { data: (0, usageConverters_1.convertOpenAIUsage)(chunk.usage), id: chunk.id, type: 'usage' },
            ];
        }
        return { data: item.delta.content, id: chunk.id, type: 'text' };
    }
    ...
    if (chunk.usage) {
        return { data: (0, usageConverters_1.convertOpenAIUsage)(chunk.usage), id: chunk.id, type: 'usage' };
    }
    return {
...
exports.transformSparkStream = transformSparkStream;
const SparkAIStream = (stream, 
// TODO: preserve for RFC 097
// eslint-disable-next-line @typescript-eslint/no-unused-vars, unused-imports/no-unused-vars
{ callbacks, inputStartAt } = {}) => {
    const readableStream = stream instanceof ReadableStream ? stream : (0, protocol_1.convertIterableToStream)(stream);
    return readableStream
        .pipeThrough((0, protocol_1.createSSEProtocolTransformer)(exports.transformSparkStream))
        .pipeThrough((0, protocol_1.createCallbacksTransformer)(callbacks));
};
exports.SparkAIStream = SparkAIStream;
