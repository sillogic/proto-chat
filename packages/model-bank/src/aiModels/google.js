...
exports.allModels = exports.nanoBananaProParameters = exports.nanoBananaParameters = exports.imagenGenParameters = void 0;
...
const googleChatModels = [
    {
        ...
        contextWindowTokens: 1048576 + 65536,
    ...
    },
    {
        ...
        contextWindowTokens: 131072 + 32768,
    ...
    },
    {
        ...
        contextWindowTokens: 32768 + 8192,
    ...
    },
    {
        ...
        contextWindowTokens: 1048576 + 8192,
    ...
    },
    {
        ...
        contextWindowTokens: 1048576 + 32768,
    ...
    {
        contextWindowTokens: 131072 + 8192,
...
exports.nanoBananaProParameters = {
    aspectRatio: {
        default: '1:1',
        enum: NANO_BANANA_ASPECT_RATIOS,
    },
...
const googleImageModels = [
    {
        ...
        description: 'Gemini 3 Pro Image（Nano Banana Pro）是 Google 的图像生成模型，同时支持多模态对话。',
        releasedAt: '2025-11-18',
        parameters: exports.nanoBananaProParameters,
        pricing: {
            approximatePricePerImage: 0.134,
            units: [
                { name: 'imageOutput', rate: 120, strategy: 'fixed', unit: 'millionTokens' },
    ...
    },
    {
        ...
        description: 'Nano Banana 是 Google 最新、最快、最高效的原生多模态模型，它允许您通过对话生成和编辑图像。',
        releasedAt: '2025-08-26',
        parameters: exports.nanoBananaParameters,
        pricing: {
            approximatePricePerImage: 0.039,
            units: [
                { name: 'textInput', rate: 0.3, strategy: 'fixed', unit: 'millionTokens' },
    ...
    },
    {
        ...
        description: 'Nano Banana 是 Google 最新、最快、最高效的原生多模态模型，它允许您通过对话生成和编辑图像。',
        releasedAt: '2025-08-26',
        parameters: standard_parameters_1.CHAT_MODEL_IMAGE_GENERATION_PARAMS,
        pricing: {
            approximatePricePerImage: 0.039,
            units: [
                { name: 'textInput', rate: 0.3, strategy: 'fixed', unit: 'millionTokens' },
    ...
    },
    {
        ...
        parameters: exports.imagenGenParameters,
        pricing: {
...
exports.allModels = [...googleChatModels, ...googleImageModels];
