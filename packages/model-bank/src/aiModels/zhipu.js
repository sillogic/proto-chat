...
const zhipuChatModels = [
    ...
    },
    {
        ...
        description: '智谱旗舰模型，支持思考模式切换，综合能力达到开源模型的 SOTA 水平，上下文长度可达128K。',
        displayName: 'GLM-4.5',
        id: 'glm-4.5',
        maxOutput: 98304,
        pricing: {
...
exports.allModels = [...zhipuChatModels, ...zhipuImageModels];
