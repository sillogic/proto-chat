...
const aihubmixModels = [
    ...
    },
    {
        ...
        contextWindowTokens: 400000,
        description: 'GPT-5.2 pro：更聪明、更精确的 GPT-5.2 版本（Responses API Only），适合高难度问题与更长的多轮推理。',
    ...
    },
    {
        ...
        contextWindowTokens: 200000,
        description: 'o3-pro 模型使用更多的计算来更深入地思考并始终提供更好的答案，仅支持 Responses API 下使用。',
        displayName: 'o3-pro',
        id: 'o3-pro',
        maxOutput: 100000,
        pricing: {
    ...
    },
    {
        ...
        description: 'Grok最新旗舰模型，在自然语言、数学和推理方面提供了无与伦比的性能——堪称完美的‘多面手’。 当前指向模型版本为grok-4-0709；注意该模型由于资源有限暂时比官方贵 10% 预计后续会降至官方原价。',
    ...
    },
    {
        ...
        contextWindowTokens: 200000,
        description: 'Sonnet 4.5 是世界上最好的代理、编码和计算机使用模型。它也是我们在长时间运行任务中最准确、最详细的模型，具有增强的编码、金融和网络安全领域知识。',
    ...
    },
    {
        ...
        contextWindowTokens: 131072,
        description: 'DeepSeek-V3.2 是一款高效的大语言模型，具备 DSA 稀疏注意力与强化推理能力，其核心亮点在于强大的 Agent 能力——通过大规模任务合成，将推理与真实工具调用深度融合，实现更稳健、合规、可泛化的智能体表现。',
...
exports.default = aihubmixModels;
