...
const vertexaiChatModels = [
    ...
    },
    {
        ...
        contextWindowTokens: 1000000 + 64000,
    ...
    },
    {
        ...
        contextWindowTokens: 1000000 + 8192,
    ...
    },
    {
        ...
        contextWindowTokens: 2000000 + 8192,
...
const vertexaiImageModels = [
    {
        ...
        description: 'Nano Banana 是 Google 最新、最快、最高效的原生多模态模型，它允许您通过对话生成和编辑图像。',
        releasedAt: '2025-08-26',
        parameters: google_1.nanoBananaParameters,
        pricing: {
            approximatePricePerImage: 0.039,
            units: [
                { name: 'textInput', rate: 0.3, strategy: 'fixed', unit: 'millionTokens' },
    ...
    },
    {
        ...
        parameters: google_1.imagenGenParameters,
        pricing: {
...
exports.allModels = [...vertexaiChatModels, ...vertexaiImageModels];
