...
const cometapiChatModels = [
    // GPT-5 series
    {
        ...
        description: 'GPT-5 是 CometAPI 提供的最新旗舰模型，适用于跨领域编码和代理任务。GPT-5 在准确性、速度、推理、上下文识别、结构化思维和问题解决方面实现了飞跃。',
    ...
    // OpenAI o series
    {
        ...
        description: 'o4-mini 是 OpenAI 的推理模型，支持图文输入并输出文本，适用于需要广泛通用知识的复杂任务。该模型具有200K上下文',
        displayName: 'o4-mini',
        enabled: true,
    ...
    },
    {
        abilities: { vision: true },
        contextWindowTokens: 200000,
        description: 'o3 Pro 是OpenAI新的推理模型，支持图文输入并输出文本，适用于需要广泛通用知识的复杂任务',
        displayName: 'o3 Pro',
        enabled: true,
    ...
    },
    {
        abilities: { functionCall: true, vision: true },
        contextWindowTokens: 200000,
        description: 'o3 是OpenAI新的推理模型，支持图文输入并输出文本，适用于需要广泛通用知识的复杂任务',
        displayName: 'o3',
        enabled: true,
        id: 'o3-2025-04-16',
        maxOutput: 200000,
    ...
    },
    {
        ...
        description: 'Gemini 2.5 flash 是 Google 快速响应的思维模型，能够对代码、数学和STEM领域的复杂问题进行推理，以及使用长上下文分析大型数据集、代码库和文档。',
...
exports.allModels = [...cometapiChatModels];
