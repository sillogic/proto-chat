...
const giteeaiImageModels = [
    ...
    {
        description: 'Stable Diffusion 3.5 Large Turbo 专注于高质量图像生成，具备强大的细节表现力和场景还原能力。',
    ...
    {
        description: 'HiDream-I1 是一个全新的开源图像生成基础模型，是由国内企业智象未来开源的。拥有 170 亿参数(Flux是12B参数)，能够在几秒内实现行业领先的图像生成质量。',
...
exports.allModels = [...giteeaiChatModels, ...giteeaiImageModels];
