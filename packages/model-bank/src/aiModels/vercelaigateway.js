...
const vercelAIGatewayChatModels = [
    {
        abilities: {
            functionCall: true,
            reasoning: true,
    ...
    },
    {
        ...
        description: '由 Google 精心调整用于聊天目的的 90 亿参数开源模型。由 Groq 使用其自定义语言处理单元 (LPU) 硬件提供服务，以提供快速高效的推理。',
...
const vercelAIGatewayEmbeddingModels = [
    {
...
exports.allModels = [...vercelAIGatewayChatModels, ...vercelAIGatewayEmbeddingModels];
