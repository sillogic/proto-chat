import { boolean, decimal, index, integer, jsonb, pgTable, serial, text, timestamp, unique, varchar } from 'drizzle-orm/pg-core';
...
export type ProtochatProvider = typeof protochatProviders.$inferSelect;
export type NewProtochatProvider = typeof protochatProviders.$inferInsert;
...
export type ProtochatModel = typeof protochatModels.$inferSelect;
export type NewProtochatModel = typeof protochatModels.$inferInsert;
...
export type ProtochatModelPricing = typeof protochatModelPricing.$inferSelect;
export type NewProtochatModelPricing = typeof protochatModelPricing.$inferInsert;
...
export type ProtochatSettings = typeof protochatSettings.$inferSelect;
export type NewProtochatSettings = typeof protochatSettings.$inferInsert;
...
export type ProtochatUsageLog = typeof protochatUsageLogs.$inferSelect;
export type NewProtochatUsageLog = typeof protochatUsageLogs.$inferInsert;
